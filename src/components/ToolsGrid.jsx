...
const toolsList = [
  ...
  { id: 4, title: "মডেল টেস্ট", desc: "পূর্ণ মডেল পরীক্ষা দিন", icon: <BarChart3 className="h-5 w-5" />, isPro: false },
  { id: 5, title: "BCS নিউজ", desc: "সর্বশেষ BCS আপডেট", icon: <Newspaper className="h-5 w-5" />, isPro: false },
  { id: 6, title: "বাংলা সাহিত্য", desc: "সাহিত্যিক ও কবিতা গাইড", icon: <BookOpen className="h-5 w-5" />, isPro: false },
