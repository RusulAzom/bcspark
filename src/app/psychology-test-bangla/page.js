    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-10 flex flex-col lg:flex-row gap-8">
          {/* ===== লেফট কলাম (75%) ===== */}
          <main className="flex-1 lg:w-3/4 space-y-12">
          ...
          <aside className="lg:w-1/4 space-y-6">
            {/* জনপ্রিয় টেস্ট */}
            <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100 top-4">
              <h3 className="text-base font-bold text-gray-800 mb-4 flex items-center gap-2">
                🔥 জনপ্রিয় মানসিক পরীক্ষা
              </h3>
        ...
        <footer className="bg-gray-900 text-gray-400 text-center py-8 px-4 text-sm">
          <p className="max-w-2xl mx-auto leading-relaxed">
            <strong className="text-white">BCSpark.bd</strong> — বাংলাদেশের প্রথম AI-চালিত ক্যারিয়ার ও মানসিক স্বাস্থ্য প্ল্যাটফর্ম। 
            আমাদের মানসিক স্বাস্থ্য পরীক্ষাগুলো (Psychology Test Bangla) সম্পূর্ণ বিনামূল্যে, গোপনীয় এবং আন্তর্জাতিকভাবে স্বীকৃত বৈজ্ঞানিক স্কেলের উপর ভিত্তি করে তৈরি।
          </p>
          <p className="mt-3 text-gray-500">
            © {new Date().getFullYear()} BCSpark — Scientific Mental Health Assessment & বাংলা সাইকোলজি টেস্ট
          </p>
        </footer>
