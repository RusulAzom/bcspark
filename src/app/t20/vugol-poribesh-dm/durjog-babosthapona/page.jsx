...
export default function durjogBabosthaponaPage() {
    const [randomQuestions, setRandomQuestions] = useState([]);
    const [isReady, setIsReady] = useState(false);

    useEffect(() => {
        // 2. ************* update here after new data নম্বর বণ্টন কর*************
        const questionsFromPrakitikDurjog = getRandomItems(prakitikDurjogBabosthapona, 20);

        // 3.**********update here after new data*****************
        const combinedQuestions = [
            ...questionsFromPrakitikDurjog
        ];
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            <QuickPracticeEngine
                ...
                config={{
                    // *************=====5. change here ======*****************
                    title: "দুর্যোগ ব্যবস্থাপনা Quiz Test - BCSpark",
