...
export default function RajnoitikOsorkarBabosthaPage() {
    const [randomQuestions, setRandomQuestions] = useState([]);
    const [isReady, setIsReady] = useState(false);

    useEffect(() => {
        const questions = getRandomItems(rajnoitikSorkarBabostha, 20);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            <QuickPracticeEngine
                ...
                config={{
                    title: "রাজনৈতিক ও সরকার ব্যবস্থা Quiz Test - BCSpark",
                    category: "GK - বাংলাদেশ বিষয়াবলী",
                    subject: "রাজনৈতিক ও সরকার ব্যবস্থা",
                    step: "07",
                    passMark: 50,
                    questionLimit: 20,
                    timeLimit: 120,
