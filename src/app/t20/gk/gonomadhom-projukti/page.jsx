...
export default function GonomadhomProjuktiPage() {
    const [randomQuestions, setRandomQuestions] = useState([]);
    const [isReady, setIsReady] = useState(false);

    useEffect(() => {
        const questions = getRandomItems(gonomadhomProjukti, 20);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            <QuickPracticeEngine
                ...
                config={{
                    title: "গণমাধ্যম ও প্রযুক্তি Quiz Test - BCSpark",
                    category: "GK - বাংলাদেশ বিষয়াবলী",
                    subject: "গণমাধ্যম ও প্রযুক্তি",
                    step: "11",
                    passMark: 50,
                    questionLimit: 20,
                    timeLimit: 120,
