...
export default function BangladeherSongbidhanPage() {
    const [randomQuestions, setRandomQuestions] = useState([]);
    const [isReady, setIsReady] = useState(false);

    useEffect(() => {
        const questions = getRandomItems(bangladeherSongbidhan, 20);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            <QuickPracticeEngine
                ...
                config={{
                    title: "বাংলাদেশের সংবিধান Quiz Test - BCSpark",
                    category: "GK - বাংলাদেশ বিষয়াবলী",
                    subject: "বাংলাদেশের সংবিধান",
                    step: "06",
                    passMark: 50,
                    questionLimit: 20,
                    timeLimit: 120,
