...
import questions from '../../../../../data/t20/ict/ict720.json';
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            <QuickPracticeEngine
                ...
                config={{
                    title: "কম্পিউটারের অঙ্গসংগঠন (CPU, Hard Disk, ALU, RAM, ROM)",
                    category: "তথ্য ও প্রযুক্তি",
                    subject: "কম্পিউটারের অঙ্গসংগঠন (CPU, Hard Disk, ALU, RAM, ROM)",
                    step: "01",
                    passMark: 50,
                    questionLimit: 20,
                    timeLimit: 120,
