...
import questions from '../../../../../data/t20/ict/ict740.json';
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            <QuickPracticeEngine
                ...
                config={{
                    title: "Computer Number System (বাইনারি, অক্টাল, হেক্সা ডেসিমল ও রুপান্তর)",
                    category: "তথ্য ও প্রযুক্তি",
                    subject: "Number System (বাইনারি, অক্টাল, হেক্সা ডেসিমল ও রুপান্তর)",
                    step: "01",
                    passMark: 50,
                    questionLimit: 20,
                    timeLimit: 120,
